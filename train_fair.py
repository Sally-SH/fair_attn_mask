...
from engine import evaluate_fair_mask, train_one_epoch_mask
...
def main(args):
  ...
  # image preprocessing
    ...
    if args.test:
        ...
        test_stats = evaluate_fair_mask(model, criterion, data_loader, device, args.output_dir)
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        train_stats = train_one_epoch_mask(args, mask_model, model, criterion, data_loader_train, optimizer, 
                                      device, epoch, args.clip_max_norm)
        lr_scheduler.step()

        # evaluate
        test_stats = evaluate_fair_mask(args, mask_model, model, criterion, data_loader_val, device, args.output_dir)
